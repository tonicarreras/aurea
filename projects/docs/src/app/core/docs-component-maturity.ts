...
const MATURITY: Record<string, DocsComponentMaturityMeta> = {
  ...
  'empty-state': { level: 'beta', since: '1.1.0' },
  accordion: { level: 'beta', since: '1.1.0' },
  fieldset: { level: 'beta', since: '1.1.0' },
  slider: { level: 'beta', since: '1.1.0' },
  'file-upload': { level: 'beta', since: '1.1.0' },
