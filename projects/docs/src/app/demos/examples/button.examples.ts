...
@Component({
  ...
  imports: [AuButton],
  template: `<button auButton variant="primary">{{ t().primary }}</button>`,
})
...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [AuButton],
  template: `<button auButton variant="secondary">{{ t().secondary }}</button>`,
})
...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [AuButton],
  template: `<button auButton variant="outline">{{ t().outline }}</button>`,
})
...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [AuButton],
  template: `<button auButton variant="ghost">{{ t().ghost }}</button>`,
})
...
@Component({
  ...
  template: `
    <div class="docs-demo-row">
      <button auButton size="sm">{{ t().sizeSm }}</button>
      <button auButton size="md">{{ t().sizeMd }}</button>
      <button auButton size="lg">{{ t().sizeLg }}</button>
    </div>
  `,
  styles: [DEMO_ROW],
})
