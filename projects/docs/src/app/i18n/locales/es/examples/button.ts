...
export const examples: ComponentDocExample[] = [
  {
    ...
    code: `<button type="button" auButton variant="primary">Guardar</button>`,
  },
  {
    title: 'Secondary',
    demoComponent: ExampleButtonSecondaryDemo,
    code: `<button type="button" auButton variant="secondary">Cancelar</button>`,
  },
  {
    title: 'Outline',
    demoComponent: ExampleButtonOutlineDemo,
    code: `<button type="button" auButton variant="outline">Más opciones</button>`,
  },
  {
    title: 'Ghost',
    demoComponent: ExampleButtonGhostDemo,
    code: `<button type="button" auButton variant="ghost">Descartar</button>`,
  },
  {
    title: 'Cargando',
    description: 'Muestra un `au-spinner` decorativo y establece `aria-busy` en el botón.',
    demoComponent: ExampleButtonLoadingDemo,
    code: `<button type="button" auButton variant="primary" [loading]="true">Guardando…</button>`,
  },
  {
    title: 'Deshabilitado',
    demoComponent: ExampleButtonDisabledDemo,
    code: `<button type="button" auButton variant="primary" [disabled]="true">No disponible</button>`,
  },
  {
    title: 'Tamaños',
    demoComponent: ExampleButtonSizesDemo,
    code: `<button type="button" auButton size="sm">Pequeño</button>
<button type="button" auButton size="md">Mediano</button>
<button type="button" auButton size="lg">Grande</button>`,
  },
];
