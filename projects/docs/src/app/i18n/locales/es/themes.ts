...
export const THEME_TOKEN_GROUPS_ES: ThemeTokenGroup[] = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { token: '--au-elevation-flat', description: 'Elevación en reposo de shells de campo.' },
      {
        ...
        description: 'Foco puntero y teclado en shells de campo.',
      },
    ],
  },
  {
  ...
  {
    title: 'Roles de elevación y foco',
    description:
      'Usa tokens de rol en componentes — no primitivas `--au-shadow-*` en producto. Las primitivas son composición interna.',
    tokens: [
      { token: '--au-elevation-flat', description: 'Inputs, cards, tablas, chips, badges.' },
      { token: '--au-elevation-tactile', description: 'Botones (secondary/outline en reposo).' },
      ...
      { token: '--au-z-popover', description: 'Capa de tooltip.' },
    ],
  },
  {
    title: 'Movimiento',
