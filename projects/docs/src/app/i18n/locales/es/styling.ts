...
export const COMPONENT_DOC_STYLING_ES: Record<string, ComponentStylingToken[]> = {
  ...
  fieldset: [
    ...
    {
      token: '--au-fieldset-description-size',
      description: 'Tipografía de la descripción por tamaño.',
    },
    { token: '--au-color-text-primary', description: 'Color del texto de la leyenda.' },
    { token: '--au-color-text-secondary', description: 'Color del texto de descripción.' },
    {
      token: '--au-space-1 / --au-space-4',
      description: 'Espaciado alrededor de leyenda y contenido.',
    },
  ],
  'input-text': [
  ...
  textarea: [
    ...
    },
    {
      ...
      description: 'Padding interno; `size` define presets sm/md/lg en el host.',
    },
  ...
  checkbox: [
    ...
    { token: '--au-focus-inset / --au-focus-tab', description: 'Foco en la casilla nativa.' },
  ],
  switch: [
    {
  ...
  select: [
    ...
    },
    {
      ...
      description: 'Fondo del listbox en portal (alias `--au-color-select-menu-bg`).',
    },
    {
      token: '--au-color-listbox-option-highlight-bg',
      description: 'Resaltado teclado/hover (aliases `--au-color-select-option-highlight-*`).',
    },
    {
      token: '--au-color-listbox-option-selected-bg',
      description: 'Opción seleccionada (aliases `--au-color-select-option-selected-*`).',
    },
    { token: '--au-elevation-overlay', description: 'Elevación del panel (`.au-floating-panel`).' },
    {
      token: '--au-field-listbox-gap',
      description: 'Separación trigger/listbox (acople flush, normalmente -1px).',
    },
  ...
  autocomplete: [
    ...
    { token: '--au-elevation-overlay', description: 'Elevación del panel de resultados.' },
    {
      token: '--au-field-listbox-gap',
      description: 'Acople flush entre campo y listbox en portal.',
    },
  ...
  accordion: [
    ...
    { token: '--au-color-surface-sunken', description: 'Fondo hover de la fila del trigger.' },
    { token: '--au-focus-inset', description: 'Anillo de foco en triggers.' },
    { token: '--au-radius-surface', description: 'Radio exterior con `variant="contained"`.' },
  ...
  'input-password': [
    ...
    { token: '--au-color-form-text', description: 'Texto del valor enmascarado.' },
    { token: '--au-size-field-px-md', description: 'Padding horizontal; escala con `size`.' },
    { token: '--au-focus-inset / --au-focus-tab', description: 'Foco en la fila de control.' },
  ],
  'tag-input': [
  ...
  'description-list': [
    ...
    { token: '--au-color-text-primary', description: 'Texto de la descripción (`dd`).' },
    { token: '--au-space-3', description: 'Ritmo vertical entre pares término/descripción.' },
  ],
  avatar: [
  ...
  drawer: [
    ...
    { token: '--au-focus-inset', description: 'Foco del botón cerrar.' },
  ],
  'radio-group': [
    ...
    { token: '--au-focus-inset / --au-focus-tab', description: 'Foco en la opción activa.' },
  ],
  'input-number': [
  ...
  slider: [
    { token: '--au-color-action-primary', description: 'Porción rellena de la pista.' },
    { token: '--au-color-surface-sunken', description: 'Fondo de la pista sin rellenar.' },
    { token: '--au-slider-fill', description: 'Variable CSS con el porcentaje de relleno.' },
    { token: '--au-focus-inset', description: 'Foco en el input range.' },
    { token: '--au-color-form-error', description: 'Contorno inválido en la fila del control.' },
    { token: '--au-text-sm', description: 'Tipografía del valor visible opcional.' },
  ],
  'input-date': [
  ...
  'input-time': [
    { token: '--au-color-form-border', description: 'Borde del campo de hora.' },
    { token: '--au-color-form-text', description: 'Texto de la hora seleccionada.' },
    { token: '--au-color-surface-raised', description: 'Fondo del campo.' },
  ...
  'file-upload': [
    { token: '--au-color-border-subtle', description: 'Borde discontinuo de la dropzone.' },
    { token: '--au-color-surface-sunken', description: 'Fondo de la dropzone.' },
    { token: '--au-color-action-primary', description: 'Borde y tinte al arrastrar.' },
    { token: '--au-color-form-error', description: 'Borde inválido de la dropzone.' },
    { token: '--au-radius-surface', description: 'Esquinas de la dropzone.' },
    { token: '--au-text-sm', description: 'Tipografía del prompt y la lista.' },
  ],
  dialog: [
    { token: '--au-color-surface-inverted', description: 'Tinte del backdrop semitransparente.' },
    { token: '--au-dialog-bg', description: 'Superficie del panel (token de dominio).' },
    { token: '--au-dialog-shadow', description: 'Elevación del panel (`--au-elevation-overlay`).' },
    ...
    { token: '--au-focus-inset', description: 'Foco en el botón de cerrar.' },
  ],
  card: [
    ...
    { token: '--au-elevation-raised', description: 'Sombra en variante elevated.' },
  ...
  tabs: [
    ...
    { token: '--au-focus-tab', description: 'Foco de teclado en botones tab y paneles.' },
  ...
  list: [
    ...
    { token: '--au-focus-inset / --au-focus-tab', description: 'Foco en ítems interactivos.' },
  ],
  chip: [
    { token: '--au-color-surface-elevated', description: 'Fondo de la variante filled.' },
  ...
  spinner: [
    ...
    { token: '--au-spinner-track', description: 'Anillo tenue detrás del arco activo.' },
    {
      ...
      description: 'Color del trazo (por defecto: `--au-color-action-primary`).',
    },
    {
  ...
  snackbar: [
    ...
    { token: '--au-elevation-raised', description: 'Elevación del toast sobre el canvas.' },
  ...
  'empty-state': [
    { token: '--au-empty-state-padding-y', description: 'Padding vertical (presets por size).' },
    { token: '--au-empty-state-padding-x', description: 'Padding horizontal (presets por size).' },
    { token: '--au-empty-state-media-size', description: 'Tamaño del contenedor icono/imagen.' },
    {
      token: '--au-empty-state-custom-max-width',
      description: 'Ancho máximo de SVG/img proyectado.',
    },
    { token: '--au-empty-state-title-size', description: 'Tipografía del título por size.' },
    {
      token: '--au-empty-state-description-size',
      description: 'Tipografía de la descripción por size.',
    },
    { token: '--au-empty-state-gap', description: 'Separación entre bloques y acciones.' },
    { token: '--au-color-surface-sunken', description: 'Fondo del contenedor icono/imagen.' },
    { token: '--au-color-text-secondary', description: 'Color de media y descripción.' },
  ],
  badge: [
  ...
  breadcrumb: [
    ...
    { token: '--au-focus-inset', description: 'Foco de teclado en enlaces.' },
  ],
  link: [
    { token: '--au-color-link', description: 'Color del enlace.' },
    { token: '--au-color-link-hover', description: 'Estado hover.' },
    { token: '--au-focus-inset', description: 'Anillo focus-visible.' },
  ...
  menu: [
    ...
    { token: '--au-elevation-overlay', description: 'Elevación del panel.' },
    { token: '--au-z-dropdown', description: 'Apilamiento sobre el contenido.' },
    { token: '--au-space-2', description: 'Padding de ítems.' },
    { token: '--au-focus-inset', description: 'Anillo focus-visible en ítems.' },
  ],
  popover: [
    { token: '--au-color-surface-elevated', description: 'Superficie del panel.' },
    { token: '--au-elevation-overlay', description: 'Sombra del panel.' },
  ...
  tooltip: [
    ...
    { token: '--au-elevation-overlay', description: 'Sombra del globo en portal.' },
