    ...
    sections: [
      {
        ...
        rows: [
          ...
          i(
            'variant',
            "'plain' | 'contained'",
            'Separadores planos o superficie elevada con borde.',
            "'plain'",
          ),
    ...
    sections: [
      {
        ...
        rows: [
          ...
          i('revealLabelShow', 'string', '`aria-label` del botón revelar.', "'Show password'"),
          i('revealLabelHide', 'string', '`aria-label` del botón ocultar.', "'Hide password'"),
          o('blur', 'void', 'Blur.'),
