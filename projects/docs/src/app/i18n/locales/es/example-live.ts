...
export const EXAMPLE_LIVE_ES: ExampleLiveMessages = {
  ...
  menu: {
    ...
    duplicate: 'Duplicar',
    delete: 'Eliminar',
    archiveDisabled: 'Archivar (no disponible)',
    placementBottom: 'Abre abajo',
    placementTop: 'Abre arriba',
    openProgrammatically: 'Abrir menú',
  },
  breadcrumb: {
    home: 'Inicio',
  ...
  pagination: {
    manyPagesHint: 'Aparecen puntos suspensivos cuando hay más de siete páginas.',
  },
  popover: {
    trigger: 'Ayuda',
    content: 'Contenido compacto del panel.',
    placementStart: 'Alineado al inicio',
    placementEnd: 'Alineado al final',
    filtersTrigger: 'Filtros',
    statusLabel: 'Estado',
    roleLabel: 'Rol',
    activeOnly: 'Solo activos',
    engineersOnly: 'Solo ingeniería',
    clear: 'Limpiar',
    apply: 'Aplicar',
    openProgrammatically: 'Abrir popover',
    helpContent: 'Texto de ayuda breve anclado al disparador.',
  },
};
