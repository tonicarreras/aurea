    ...
    sections: [
      {
        ...
        rows: [
          ...
          i('variant', "'plain' | 'contained'", 'Plain dividers or raised surface shell.', "'plain'"),
    ...
    sections: [
      {
        ...
        rows: [
          ...
          i('revealLabelShow', 'string', 'Reveal button `aria-label` when hidden.', "'Show password'"),
          i('revealLabelHide', 'string', 'Reveal button `aria-label` when visible.', "'Hide password'"),
          o('blur', 'void', 'Blur.'),
