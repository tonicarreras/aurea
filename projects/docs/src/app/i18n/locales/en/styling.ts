...
export const COMPONENT_DOC_STYLING_EN: Record<string, ComponentStylingToken[]> = {
  button: [
    ...
    { token: '--au-color-focus-ring', description: 'Visible focus ring when tabbing.' },
    {
  ...
  'input-text': [
    ...
    { token: '--au-color-focus-ring', description: 'Focus border and shadow (`:focus-within`).' },
  ],
  textarea: [
    ...
    { token: '--au-color-focus-ring', description: 'Focus indicator on the container.' },
  ],
  checkbox: [
    {
    ...
    { token: '--au-color-focus-ring', description: 'Ring when the native checkbox is focused.' },
  ],
  switch: [
    {
  ...
  select: [
    { token: '--au-color-form-border', description: 'Dropdown trigger border.' },
    { token: '--au-color-select-field-hover-bg', description: 'Trigger background on hover.' },
    { token: '--au-color-select-menu-bg', description: 'Portaled listbox background.' },
    {
      token: '--au-color-select-option-highlight-bg',
      description: 'Option highlighted when navigating with the keyboard.',
    },
    {
      token: '--au-color-select-option-selected-bg',
      description: 'Currently selected option.',
    },
    { token: '--au-shadow-overlay', description: 'Dropdown panel shadow.' },
  ...
  autocomplete: [
    { token: '--au-color-form-border', description: 'Search field border.' },
    { token: '--au-color-select-field-hover-bg', description: 'Field background on hover.' },
    { token: '--au-color-select-menu-bg', description: 'Suggestion list background.' },
    {
      token: '--au-color-select-option-highlight-bg',
      description: 'Active suggestion (keyboard or hover).',
    },
    { token: '--au-color-form-text', description: 'Typed text and option labels.' },
    { token: '--au-shadow-overlay', description: 'Results panel elevation.' },
  ...
  dialog: [
    ...
    { token: '--au-color-surface-raised', description: 'Dialog panel.' },
    { token: '--au-shadow-overlay', description: 'Panel elevation above the backdrop.' },
    ...
    { token: '--au-color-focus-ring', description: 'Focus on the close button.' },
  ],
  card: [
  ...
  chip: [
    ...
    { token: '--au-color-focus-ring', description: 'Focus when the chip is interactive.' },
  ],
  message: [
