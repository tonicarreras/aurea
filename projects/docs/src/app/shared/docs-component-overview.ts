            ...
            <div class="docs-overview__exports">
              ...
              <ul class="docs-overview__export-chips">
                @for (exportName of o.relatedExports; track exportName) {
                  <li><code class="docs-overview__chip">{{ exportName }}</code></li>
                }
              </ul>
            </div>
          }
  ...
  styles: [
    `
      ...
      .docs-overview__intro {
        ...
        background: color-mix(in srgb, var(--au-color-surface-raised) 70%, var(--au-color-surface-canvas));
      }
      ...
      .docs-overview__card--alt {
        background: color-mix(in srgb, var(--au-color-surface-sunken) 40%, var(--au-color-surface-raised));
      }
