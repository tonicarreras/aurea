...
@Component({
  ...
  template: `
    <docs-page
      [title]="i18n.messages().guides.composition.title"
      [lead]="i18n.messages().guides.composition.lead"
    >
      <docs-guide-sections [sections]="sections()" />
    </docs-page>
  `,
})
export class GuideCompositionPage {
  readonly i18n = inject(DocsLocaleService);
  readonly sections = computed(() => this.i18n.messages().guides.composition.sections);
}
