...
@Component({
  ...
  template: `
    ...
    >
      <section
        class="docs-home-stats"
        [attr.aria-label]="i18n.messages().home.statsAria"
      >
      ...
      <section
        class="docs-home-grid"
        [attr.aria-label]="i18n.messages().home.exploreAria"
      >
        @for (card of exploreCards(); track card.title; let i = $index) {
          ...
          >
            ...
            >
              <p
                auCardBody
                class="docs-home-grid__body"
              >
                <span
                  class="docs-home-grid__icon"
                  aria-hidden="true"
                  >{{ card.icon }}</span
                >
