...
@Component({
  ...
  template: `
    <docs-page
      [title]="i18n.messages().ecosystem.migrateCdk.title"
      [lead]="i18n.messages().ecosystem.migrateCdk.lead"
    >
      <docs-guide-sections [sections]="sections()" />
    </docs-page>
  `,
})
export class GuideMigrateCdkPage {
  readonly i18n = inject(DocsLocaleService);
  readonly sections = computed(() => this.i18n.messages().ecosystem.migrateCdk.sections);
}
