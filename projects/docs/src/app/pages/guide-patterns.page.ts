...
@Component({
  ...
  template: `
    <docs-page
      [title]="i18n.messages().guides.patterns.title"
      [lead]="i18n.messages().guides.patterns.lead"
    >
      <docs-guide-sections [sections]="sections()" />
    </docs-page>
  `,
})
export class GuidePatternsPage {
  readonly i18n = inject(DocsLocaleService);
  readonly sections = computed(() => this.i18n.messages().guides.patterns.sections);
}
