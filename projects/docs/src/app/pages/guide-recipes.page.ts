...
@Component({
  ...
  template: `
    <docs-page
      [title]="i18n.messages().guides.recipes.title"
      [lead]="i18n.messages().guides.recipes.lead"
    >
      <docs-guide-sections [sections]="sections()" />
    </docs-page>
  `,
})
export class GuideRecipesPage {
  readonly i18n = inject(DocsLocaleService);
  readonly sections = computed(() => this.i18n.messages().guides.recipes.sections);
}
