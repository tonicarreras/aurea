...
@Component({
  ...
  template: `
    <docs-page
      [title]="i18n.messages().guides.bundleSize.title"
      [lead]="i18n.messages().guides.bundleSize.lead"
    >
      <docs-guide-sections [sections]="sections()" />
    </docs-page>
  `,
})
export class GuideBundleSizePage {
  readonly i18n = inject(DocsLocaleService);
  readonly sections = computed(() => this.i18n.messages().guides.bundleSize.sections);
}
